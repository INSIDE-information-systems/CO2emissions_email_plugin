(function () {
  ...
  var afbCalculator = {
    ...
    form_datasize(sizes, extension) {
      ...
      textformat += "<span style='font-style: italic; color:grey; font-size:85%;'>Installez vous aussi <span style='color:green;'>Estimate_your_CO2</span> pour Thunderbird pour évaluer l'impact environnemental de vos envois mail: <a href='https://github.com/INSIDE-information-systems/CO2emissions_email_plugin'>Lien pour télécharger l'extension Thunderbird</a>.<br>\
      <span style='color:green;'>Estimate_your_CO2</span> est développé par l'Agence française pour la biodiversité, plus d'info sur <a href='https://www.afbiodiversite.fr/estimate_your_CO2'>https://www.afbiodiversite.fr/estimate_your_CO2</a></span>";
      return textformat;
    },
